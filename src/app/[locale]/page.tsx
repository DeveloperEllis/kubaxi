...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
            ...
            <nav className="pt-4">
              <div className="grid grid-cols-2 md:flex md:flex-row justify-center gap-3 md:gap-4 max-w-4xl mx-auto">
                ...
                >
                  <span className="flex items-center justify-center gap-2">
                    <span className="text-lg">✨</span>
                    <span className="text-sm md:text-base">{t('hero.customTrip')}</span>
                  </span>
                </button>
              </div>
            </nav>
            ...
            <form className="space-y-6" onSubmit={(e: FormEvent<HTMLFormElement>) => {
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <input
                  type="email"
                  name="email"
                  placeholder={t('customTrip.email')}
                  className="px-5 py-4 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none"
                  required
                />
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <input
                  type="tel"
                  name="telefono"
                  placeholder={t('customTrip.phone')}
                  className="px-5 py-4 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none"
                  required
                />
                <input
                  type="number"
                  name="viajeros"
                  placeholder={t('customTrip.travelers')}
                  min="1"
                  defaultValue="1"
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-semibold text-slate-700 mb-2">📅 {t('customTrip.startDate')}</label>
                  <input
                    type="date"
                    name="fecha"
              ...
              <textarea
                name="descripcion"
                placeholder={t('customTrip.preferences')}
                rows={5}
      ...
      <a
        href="https://wa.me/5352375007?text=Hola,%20necesito%20información%20sobre%20sus%20servicios%20de%20transporte."
        target="_blank"
